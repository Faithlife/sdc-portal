  ...
  return when.promise(function (resolve, reject) {
    ...
    .then(function (keyData) {
      clients[clientKey] = smartdc.createClient({
        ...
        account: config.sdc.users[user].login,
 ...
 */
[
  'createKey', 'getAccount', 'getImage', 'getMachine', 'getMachineAudit',
  'listKeys', 'listMachines', 'rebootMachine', 'startMachine', 'stopMachine'
